...
from user.api.v1.router import api_router
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="User surface — modular monolith slice, ready to extract.",
        docs_url="/docs",
        redoc_url="/redoc",
    )
    ...
    app.include_router(api_router, prefix=f"/user{settings.api_prefix}")
    return app

...
import { AgentCard } from "@/lib/domains/agent/features/agent-card";
import { AgentDrawer } from "@/lib/domains/agent/features/agent-drawer";
import { listAgents } from "@/lib/domains/agent/controllers/agent.controller";
import type { AgentRecord } from "@/lib/domains/agent/types";

export default function AgentsPage() {
  usePageTitle("Agents — Delegate Labs");

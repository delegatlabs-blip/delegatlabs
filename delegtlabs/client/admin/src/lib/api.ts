...
const dummyAgents: Agent[] = [
  {
    ...
    category: "linkedin",
    description: "Creates founder posts, connection nudges, and weekly authority content.",
    base_price_inr: "14999.00",
    base_price_usd: "179.00",
  ...
  },
  {
    ...
    slug: "facebook-ads-optimizer",
    category: "facebook_ads",
    description: "Monitors campaigns, rewrites ads, and suggests budget shifts from performance signals.",
    base_price_inr: "9999.00",
    base_price_usd: "119.00",
  ...
  },
  {
    ...
    category: "instagram",
    description: "Builds reels scripts, carousel outlines, captions, and hashtag sets for campaigns.",
    base_price_inr: "7999.00",
    base_price_usd: "99.00",
    billing_unit: "per_post",
    status: "draft",
    version: 1,
  },
  {
    ...
    slug: "email-lifecycle-agent",
    category: "email",
    description: "Drafts onboarding, reactivation, and launch sequences with segmented messaging.",
    base_price_inr: "12999.00",
  ...
  },
  {
    ...
    slug: "seo-brief-agent",
    category: "seo",
    description: "Turns keyword clusters into briefs, outlines, internal links, and optimization checklists.",
    base_price_inr: "6999.00",

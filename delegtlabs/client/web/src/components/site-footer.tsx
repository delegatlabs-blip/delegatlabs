        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_2fr]">
          <div>
            ...
            <div className="mt-6">
              ...
              <form className="mt-3 flex max-w-sm gap-2" action="#" method="get">
                <input
                  type="email"
                  name="email"
                  required
                  ...
                  className="min-w-0 flex-1 rounded-xl border border-white/15 bg-white/5 px-3 py-2.5 text-sm text-white placeholder:text-white/40 focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/30"
                  data-cursor-exclude
                />
                <button
                  type="submit"
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {footerColumns.map((col) => (
              <div key={col.title}>
                <h3
                  className={`mb-4 bg-gradient-to-r text-xs font-bold uppercase tracking-widest ${col.gradient} bg-clip-text text-transparent`}
                >
                  {col.title}
                </h3>

...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-[60] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl shadow-[#25D366]/40 transition-all duration-300 hover:scale-110 hover:bg-[#20BD5A] hover:shadow-[#25D366]/60"
      data-cursor-exclude
    >

...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Configure workspace, preferences and integrations." },
      { property: "og:title", content: "Settings — Vertex OS" },
      { property: "og:description", content: "Configure workspace, preferences and integrations." },
    ],
  }),
